...
export const createUserRepository = async ({name, email, password, role, verificationToken}: INewUser): Promise<null | IUserSchema> => {
...
export const createTokenRepository = async ({refreshToken, ip, userAgent, user}: ITokenSchema): Promise<null | ITokenSchema> => {
